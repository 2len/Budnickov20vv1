// Логика1.5.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main() {
    ...
    strcpy(student[0].name, "Арсений");
    strcpy(student[0].surname, "Кирюшин");
    strcpy(student[0].thirdname, "Алекеевич");
    student[0].grade = 1;

    strcpy(student[1].name, "Павел");
    strcpy(student[1].surname, "Малыгин");
    strcpy(student[1].thirdname, "Михайлович");
    student[1].grade = 2;

    strcpy(student[2].name, "Сергей");
    strcpy(student[2].surname, "Меланин");
    strcpy(student[2].thirdname, "Сергеевич");
    student[2].grade = 2;
